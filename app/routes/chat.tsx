...
import { LoaderArgs, type ActionArgs, json } from "@remix-run/node";
import {
  Form,
  useActionData,
  useNavigation,
...
export async function loader({ request }: LoaderArgs) {
  const myContext = await prisma.context.findFirst({
    orderBy: {
      createdAt: "desc",
    },
  });
  return json({
    assistantRole: myContext?.assistantRole,
    rubric: myContext?.rubric,
    requirements: myContext?.requirements,
  });
}
